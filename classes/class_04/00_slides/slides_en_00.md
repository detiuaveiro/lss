...
## What is a "Static" Webpage? i
  ...
  * Core technologies: **[HTML](https://en.wikipedia.org/wiki/HTML)** (for structure) and **[CSS](https://en.wikipedia.org/wiki/CSS)** (for style).
...
Let's break that down:
  ...
  * **HyperText:** This refers to text that contains links ("[hyperlinks](https://en.wikipedia.org/wiki/Hyperlink)") to other texts (or pages). This is the fundamental concept that connects the entire web.
  * **Markup Language:** This is *not* a programming language.
      * A **[programming language](https://en.wikipedia.org/wiki/Programming_language)** *does* things (e.g., `if (x > 5) { do_something() }`).
      * A **[markup language](https://en.wikipedia.org/wiki/Markup_language)** *describes* things. It uses "tags" to define the structure and meaning of the content.
...
## The Evolution to HTML5 i

### Older HTML (HTML4):
We only had one generic container: `<div>`. 
This led to code that was hard to read for both developers and machines (like screen readers or search engines).
...
## Why HTML5 Semantics Matter ii
  
2.  **[Search Engine Optimization (SEO):](https://en.wikipedia.org/wiki/Search_engine_optimization)**
...
## HTML5 Media: Images `<img>` ii

```html
<!-- A standard image -->
<img src="images/my-photo.jpg" alt="caption for a image">

<!-- An animated GIF uses the same tag -->
<img src="gifs/funny-reaction.gif" alt="animated gif">

<!-- An image loaded from an external website -->
<img src="https://placehold.co/400" alt="placehold.co">
```

## HTML5 Media: Audio `<audio>`
...
## Real-Time Dynamics: WebSockets ii
...
* It is an extremely lightweight **publish/subscribe (pub/sub)** protocol, popular for **[IoT](https://en.wikipedia.org/wiki/Internet_of_things)** (Internet of Things) devices.
* **Pub/Sub Model:**
...
This `docker-compose.yml` file is the recipe for your server:
...
## Why does [SOP](https://en.wikipedia.org/wiki/Same-origin_policy) exist?
