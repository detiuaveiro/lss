...
* **MAC Address (Physical Address):**
  ...
  * A unique, 48-bit serial number burned into the network card by the manufacturer. While intended to be permanent, it can be **spoofed** for privacy or security.
...
## The Language: IPv4 & The Subnet Mask
...
## Leaving the LAN: The Default Gateway
...
* **mDNS (Multicast DNS):**
  ...
  * Implemented by services like **Avahi** (Linux) or **Bonjour** (macOS/Windows).
...
## Keeping the Network Running: NTP & SNMP
...
## The Power of SSH: VS Code Remote
...
## The Modern Web: HTTPS & Let's Encrypt
